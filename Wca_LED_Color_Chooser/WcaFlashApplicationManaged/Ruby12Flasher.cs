        ...
        public void OnReceive(IInterface sender, byte[] data, int dataLength)
        {
            ...
            if (dataLength>5)
            {
                if (data[0] == 0x55 && data[4] == 0x26 && data[5]==0x01)
                {
                    ...
                    Console.WriteLine("Charger ready.");

                }
                else if (data[0] == 0x55 && data[4] == 0x1E && dataLength >= 8)
                {
                    Console.WriteLine("\nVersion:" + data[5] + "." + data[6] + "." + data[7] + "." + data[8]);
                }
                else if(data[0] == 0x55 && data[4] == 0x2E && data[5] == 0x00)
                {
                    Console.Write(".");
                }
                else if(data[0]==0x55 && data[4] == 0x24)
                {
            ...
            Console.WriteLine("R:" + WcaInterfaceLibrary.Converter.ByteArray2String(data));
